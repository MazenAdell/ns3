...
//  |  t2   |  |  t3   |                                                  //
//  |  UDP  |  |  UDP  |                                                  //
//  |  echo |  |  echo |    Node t2 is a UDP echo client (single-switch)   //
...
//           [X]                                                          //
//          CSMA                                                          //
//   ------------------     Nodes bs1 to bs3 are L2 switches              //
...
// ---------------------------------------------------------------------- //
//      t2     : 192.168.1.2 : Top single-switch UDP echo client          //
...
main (int argc, char *argv[])
{
  ...
  // Single-switch top LAN chain: t2-ts1-tr
  NetDeviceContainer link_t2_ts1  = csmaY.Install (NodeContainer (t2, ts1));
  ...
  NetDeviceContainer link_b2_bs3   = csmaY.Install (NodeContainer (b2,  bs3));
  ...
  botLanIpDevices.Add (link_b2_bs3.Get (0));  //       for IP address
  ...
  if (enableUdpMultiSW)
    {
      ...
      // ------------------------------------------------------------------
      // Install Single-switch UDP echo client on t2
      // ------------------------------------------------------------------
      NS_LOG_INFO ("APP: Single-Switch UDP client (on node t2 of top LAN)");
